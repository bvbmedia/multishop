...
if ($this->ms['MODULES']['CACHE_FRONT_END'])
{
	...
	if (!$this->cacheLifeTime) $this->cacheLifeTime=$this->ms['MODULES']['CACHE_TIME_OUT_CATEGORIES_NAVIGATION_MENU'];		
	$options = array(
		'caching' => true,
...
if (!$this->ms['MODULES']['CACHE_FRONT_END'] or !$categories=$Cache_Lite->get($string))
{
	...
	if ($this->ms['MODULES']['CACHE_FRONT_END'])	$Cache_Lite->save($categories);		
}
$content .= '
