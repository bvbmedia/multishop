...
$query=$GLOBALS['TYPO3_DB']->SELECTquery('m.manufacturers_id, m.manufacturers_name, m.manufacturers_image', // SELECT ...
	'tx_multishop_manufacturers m LEFT JOIN tx_multishop_manufacturers_info mi on m.manufacturers_id=mi.manufacturers_id', // FROM ...
	'm.status=1 and mi.language_id=\''.$this->sys_language_uid.'\'', // WHERE...
	'', // GROUP BY...
