...
if (count($cart['products'])<1) {
	...
	if ($erno or $show_checkout_address) {
		...
		<div class="account-field" id="input-gender">
		...
		<div class="account-field" id="input-fname">
		...
		<div class="account-field" id="input-mname">
		...
		<div class="account-field" id="input-lname">
		...
		<div class="account-field" id="input-state">
		...
		$content.='
		<div class="account-field" id="input-email">
		...
		<div class="account-field" id="input-telephone">
		...
		$tmpcontent.='
			...
			<div class="account-field" id="input-dfgender">
			...
			<div class="account-field" id="input-dffname">
			...
			<div class="account-field" id="input-dflname">
			...
			<div class="account-field" id="input-dfcompany">
			...
			<div class="account-field" id="input-dfaddress">
			...
			<div class="account-field" id="input-dfhousenumber">
			...
			<div class="account-field" id="input-dfextension">
			...
			<div class="account-field" id="input-dfzip">
			...
			<div class="account-field" id="input-dfcity">
			...
			<div class="account-field" id="input-dfstate">
				'.($this->ms['MODULES']['CHECKOUT_ENABLE_STATE'] ? '
		...
		if ($tmpcontent_con) {
			$tmpcontent.='
			<div class="account-field" id="input-dfcountry">
		...
		$tmpcontent.='
		<div class="account-field" class="input-dfemail">
		...
		<div class="account-field" id="input-dftelephone">
		...
		<div class="account-field" id="input-dfmobile">
