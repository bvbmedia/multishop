...
$query=$GLOBALS['TYPO3_DB']->SELECTquery('cd.content, cd.name, c.type', // SELECT ...
	...
	'c.page_uid=\''.$this->shop_pid.'\' and c.id=cd.id and cd.language_id=\''.$GLOBALS['TSFE']->sys_language_uid.'\' and c.hash=\''.addslashes($this->get['tx_multishop_pi1']['cms_hash']).'\'', // WHERE...
	'', // GROUP BY...
	'', // ORDER BY...
	'' // LIMIT ...
);
