		...
		if ($this->get['optid']==0) {
            ...
            if ($GLOBALS['TYPO3_DB']->sql_num_rows($qry_option)>0) {
                while (($rs_option=$GLOBALS['TYPO3_DB']->sql_fetch_assoc($qry_option))!=false) {
                    ...
                    $option_data[$rs_option['sort_order_option_value']]['valid']=$rs_option['options_values_id'];
                    $option_data[$rs_option['sort_order_option_value']]['valname']=$rs_option['products_options_values_name'];
                    $option_data[$rs_option['sort_order_option_value']]['values_price']=$rs_option['options_values_price'];
                    $option_data[$rs_option['sort_order_option_value']]['display_values_price']=mslib_fe::taxDecimalCrop($rs_option['options_values_price'], 2, false);
                    $option_data[$rs_option['sort_order_option_value']]['display_values_price_including_vat']=$attribute_price_display_incl;
                    $option_data[$rs_option['sort_order_option_value']]['price_prefix']=$rs_option['price_prefix'];
                    $ctr++;
                }
            }
		}
