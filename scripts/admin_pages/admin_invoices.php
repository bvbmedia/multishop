...
if ($this->cookie['limit']) $this->get['limit']=$this->cookie['limit'];
else						$this->get['limit']=15;
...
if ($this->cookie['paid_invoices_only']) $filter[]="(i.paid='1')";		
if (!$this->masterShop) $filter[]='i.page_uid='.$this->showCatalogFromPage;
...
else $tmp=$this->pi_getLL('no_invoices_found').'.';
$tabs=array();
$tabs['Invoices_By_Date']=array($this->pi_getLL('admin_invoices'),$tmp);
$tmp='';
$content.='
