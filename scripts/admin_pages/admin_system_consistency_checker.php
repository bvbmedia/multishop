...
// Delete options that are having no option values
$query='DELETE FROM tx_multishop_products_options WHERE products_options_id NOT IN (SELECT DISTINCT products_options_id from tx_multishop_products_options_values_to_products_options)';
$res = $GLOBALS['TYPO3_DB']->sql_query($query);
