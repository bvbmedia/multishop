...
$where_status='';
if ($parent_id>0) {
    $where_status.=' and c.parent_id=' . $parent_id;
} else {
    $where_status.=' and p2c.is_deepest=1';
}
//
$query_c=$GLOBALS['TYPO3_DB']->SELECTquery('p2c.categories_id, cd.categories_name', // SELECT ...
    ...
    'c.page_uid='.$this->showCatalogFromPage.' and cd.language_id='.$this->sys_language_uid . $where_status .' and p2c.categories_id=c.categories_id and c.categories_id=cd.categories_id', // WHERE...
