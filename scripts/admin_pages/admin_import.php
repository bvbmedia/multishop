...
//													die();
					...
					if (!$skip) {
						...
						$products_id='';
						if (isset($item['products_vat_rate']) and (!$item['imported_product'] or ($item['imported_product'] and is_array($importedProductsLockedFields) && !in_array('products_vat_rate', $importedProductsLockedFields)))) {
							...
							if ($tax_id) {
								$item['tax_id']=$tax_id;
							} elseif ($this->post['tx_multishop_pi1']['default_vat_rate'] and (!$item['imported_product'] or ($item['imported_product'] and is_array($importedProductsLockedFields) && !in_array('products_vat_rate', $importedProductsLockedFields)))) {
...
//								error_log('old_product: '.print_r($old_product,1));
							$updateArray=array();
							if (isset($item['tax_id']) and (!$item['imported_product'] or ($item['imported_product'] and is_array($importedProductsLockedFields) && !in_array('products_vat_rate', $importedProductsLockedFields)))) {
							...
							if (isset($item['products_price']) and (!$item['imported_product'] or ($item['imported_product'] and is_array($importedProductsLockedFields) && !in_array('products_price', $importedProductsLockedFields)))) {
							...
							if (isset($item['products_quantity']) and (!$item['imported_product'] or ($item['imported_product'] and is_array($importedProductsLockedFields) && !in_array('products_quantity', $importedProductsLockedFields)))) {
							...
							if (isset($item['products_name']) and (!$item['imported_product'] or ($item['imported_product'] and is_array($importedProductsLockedFields) && !in_array('products_name', $importedProductsLockedFields)))) {
							...
							if (isset($item['products_description_encoded']) and (!$item['imported_product'] or ($item['imported_product'] and is_array($importedProductsLockedFields) && !in_array('products_description', $importedProductsLockedFields)))) {
								$updateArray['products_description']=$item['products_description_encoded'];
							} elseif ($item['products_description'] and (!$item['imported_product'] or ($item['imported_product'] and is_array($importedProductsLockedFields) && !in_array('products_description', $importedProductsLockedFields)))) {
								$updateArray['products_description']=$item['products_description'];
							}
							...
							if (count($this->ms['products_to_categories_array']) and (!$item['imported_product'] or ($item['imported_product'] and is_array($importedProductsLockedFields) && !in_array('categories_id', $importedProductsLockedFields)))) {
								if (!$this->post['incremental_update']) {
							...
							if ((isset($item['products_price']) or isset($item['products_old_price'])) and (!$item['imported_product'] or ($item['imported_product'] and is_array($importedProductsLockedFields) && !in_array('products_price', $importedProductsLockedFields)))) {
								if ($item['products_old_price']) {
