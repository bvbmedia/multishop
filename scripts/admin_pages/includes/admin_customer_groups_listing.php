...
foreach ($groups as $group) {
	...
	$status_html = '';
	if (!$group['hidden']) {     
		$link = mslib_fe::typolink(',2003','tx_multishop_pi1[page_section]='.$this->ms['page'].'&customer_group_id='.$group['uid'].'&disable=1&'.mslib_fe::tep_get_all_get_params(array('customer_group_id','disable','clearcache')));
		...
		$link = mslib_fe::typolink(',2003','tx_multishop_pi1[page_section]='.$this->ms['page'].'&customer_group_id='.$group['uid'].'&disable=0&'.mslib_fe::tep_get_all_get_params(array('customer_group_id','disable','clearcache')));			
	...
	$markerArray['VALUE_GROUP_EDIT_LINK'] 		= mslib_fe::typolink(',2002','&tx_multishop_pi1[page_section]=admin_ajax&customer_group_id='.$group['uid']).'&action=edit_customer_group';
	...
	$markerArray['VALUE_GROUP_DELETE_LINK'] 	= mslib_fe::typolink(',2003','tx_multishop_pi1[page_section]='.$this->ms['page'].'&customer_group_id='.$group['uid'].'&delete=1&'.mslib_fe::tep_get_all_get_params(array('customer_group_id','delete','disable','clearcache')));
