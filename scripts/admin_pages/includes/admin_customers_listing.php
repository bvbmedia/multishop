...
foreach($customers as $customer) {
	...
	if($rows > 0) {
		...
		$latest_order.='<a href="'.mslib_fe::typolink(',2002', '&tx_multishop_pi1[page_section]=admin_ajax&orders_id='.$order['orders_id']).'&action=edit_order" onclick="return hs.htmlExpand(this, { objectType: \'iframe\', width: 950, height: 600} )">'.$order['orders_id'].'</a>'."\n";
		if($rows > 1) {
