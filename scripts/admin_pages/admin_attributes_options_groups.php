...
<div class="new_options_groups_name_input"><label for="new_options_groups_name">'.$this->pi_getLL('admin_label_add_new_options_group').':</label> <input type="text" name="new_options_groups_name" id="new_options_groups_name" /> <input type="submit" name="add_new_options_groups" value="'.$this->pi_getLL('add').'"></div>
</form>';
