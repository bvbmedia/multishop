...
$html.='
        ...
        $(document).on(\'mouseenter\', \'ul.dropdown-menu>li>a, ul.dropdown-menu>li>span\', function (e) {
        ...
        $(document).on(\'mouseleave\', \'ul.dropdown-menu>li>a, ul.dropdown-menu>li>span\', function (e) {
