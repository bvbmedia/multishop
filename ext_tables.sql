...
CREATE TABLE `fe_users` (
  ...
  `image` tinytext,
  `TSconfig` text,
  `fe_cruser_id` int(10) NOT NULL default '0',
  ...
  `by_invitation` tinyint(4) NOT NULL default '0',
  `module_sys_dmail_html` tinyint(3) NOT NULL default '0',
  ...
  `tx_multishop_optin_crdate` int(10) NOT NULL default '0',
  `address_ext` varchar(10) NOT NULL DEFAULT '',
  `tx_multishop_source_id` varchar(50) NOT NULL DEFAULT '',
...
CREATE TABLE `tx_multishop_invoices` (
  ...
  `store_currency` char(3) NOT NULL DEFAULT '',
  `customer_currency` char(3) NOT NULL DEFAULT '',
  `currency_rate` varchar(15) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
...
CREATE TABLE `tx_multishop_orders` (
  ...
  `billing_address_ext` varchar(10) NOT NULL DEFAULT '',
  `delivery_address_ext` varchar(10) NOT NULL DEFAULT '',
  `hash` varchar(50) NOT NULL DEFAULT '0',
  `cruser_id` int(11) NOT NULL DEFAULT '0',
  `is_proposal` tinyint(1) NOT NULL DEFAULT '0',
  `track_and_trace_code` varchar(50) NOT NULL DEFAULT '',
  `expected_delivery_date` int(11) NOT NULL DEFAULT '0',
  `store_currency` char(3) NOT NULL DEFAULT '',
  `customer_currency` char(3) NOT NULL DEFAULT '',
  `currency_rate` varchar(15) NOT NULL DEFAULT '1',
  `language_id` int(5) NOT NULL DEFAULT '0',
  `orders_tax_data` text,
  `status_last_modified` int(11) NOT NULL DEFAULT '0',
  `reminder_sent` tinyint(1) NOT NULL DEFAULT '0',
  `grand_total` decimal(24,14) DEFAULT '0.00000000000000',
  `billing_street_name` varchar(75) NOT NULL DEFAULT '',
...
CREATE TABLE `tx_multishop_orders_products` (
  ...
  `file_label` varchar(250) NOT NULL DEFAULT '',
  `file_location` varchar(250) NOT NULL DEFAULT '',
  `file_downloaded` int(11) NOT NULL DEFAULT '0',
  `file_download_code` varchar(32) NOT NULL DEFAULT '0',
  `file_locked` tinyint(1) NOT NULL DEFAULT '0',
  `qty_delivered` int(4) NOT NULL DEFAULT '0',
  `qty_not_deliverable` int(4) NOT NULL DEFAULT '0',
  `file_remote_location` text NOT NULL,
  `file_number_of_downloads` int(11) NOT NULL DEFAULT '0',
  `products_tax_data` text NOT NULL,
  `order_unit_id` int(11) NOT NULL DEFAULT '0',
  `order_unit_name` varchar(100) NOT NULL DEFAULT '',
  `order_unit_code` varchar(15) NOT NULL DEFAULT '',
...
CREATE TABLE `tx_multishop_orders_products_downloads` (
  ...
  `date_of_download` int(11) NOT NULL default '0',
  PRIMARY KEY (`orders_products_id`),
...
CREATE TABLE `tx_multishop_stores` (
  ...
  `fax` varchar(20) NOT NULL DEFAULT '',
  `status` tinyint(1) NOT NULL DEFAULT '0',
  `lng` double(18,14) NOT NULL DEFAULT '0.00000000000000',
  `lat` double(18,14) NOT NULL DEFAULT '0.00000000000000',
  PRIMARY KEY (`id`),
  KEY `lat` (`lat`,`lng`),
  KEY `status` (`status`)
) ENGINE=InnoDB;
...
CREATE TABLE `tx_multishop_tax_rules` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `rules_group_id` int(11) NOT NULL default '0',
  `cn_iso_nr` int(11) NOT NULL default '0',
  `zn_country_iso_nr` int(11) NOT NULL default '0',
  `tax_id` int(11) NOT NULL default '0',
  `state_modus` tinyint(1) NOT NULL default '0',
  `county_modus` tinyint(1) NOT NULL default '0',
  `country_tax_id` int(11) NOT NULL default '0',
  PRIMARY KEY (`rule_id`)
) ENGINE=InnoDB ;
