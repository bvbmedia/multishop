...
CREATE TABLE `fe_users` (
  ...
  `image` tinytext,
  `TSconfig` text,
  `fe_cruser_id` int(10) default '0',
  `lastlogin` int(10) default '0',
  `is_online` int(10) default '0',
  `felogin_redirectPid` tinytext,
  `felogin_forgotHash` varchar(80) default '',
  `static_info_country` char(3) default '',
  `zone` varchar(45) default '',
  `language` char(2) default '',
  `gender` varchar(1) default '',
  `cnum` varchar(50) default '',
  `first_name` varchar(50) default '',
  `last_name` varchar(50) default '',
  `status` int(11) default '0',
  `date_of_birth` int(11) default '0',
  `comments` text,
  `by_invitation` tinyint(4) default '0',
  `module_sys_dmail_html` tinyint(3) default '0',
...
CREATE TABLE `tx_multishop_products_attributes` (
  `products_attributes_id` int(5) auto_increment,
  `products_id` int(11) default '0',
...
CREATE TABLE `tx_multishop_products_faq` (
  `products_faq_id` int(11) auto_increment,
  `products_id` int(11) default '0',
