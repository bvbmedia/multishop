...
CREATE TABLE `fe_users` (
  ...
  `tx_multishop_payment_due_period` varchar(50) default '',
  ...
  KEY `tx_multishop_payment_due_period` (`tx_multishop_payment_due_period`),
  KEY `disable` (`disable`),
  KEY `deleted` (`deleted`),
  KEY `crdate` (`crdate`),
...
CREATE TABLE `tx_multishop_orders` (
  ...
  `payment_due_period` varchar(50) default '',
  `order_memo` text,
  `paid` tinyint(1) default '0',
