...
CREATE TABLE `tx_multishop_invoices` (
 ...
 `debit_invoice` tinyint(1) default '0',
 PRIMARY KEY (`id`),
 ...
 KEY `debit_invoice` (`debit_invoice`)
);
...
CREATE TABLE `tx_multishop_orders` (
 ...
 `delivery_state` varchar(150) default '',
 ...
 `delivery_coc_id` varchar(150) default '',
 ...
 `delivery_birthday` int(11) default '0',
...
CREATE TABLE tt_address (
 ...
 tx_multishop_bank_name varchar(127) default '',
 tx_multishop_iban varchar(127) default '',
 tx_multishop_bic varchar(127) default '',
 tx_multishop_vat_id varchar(127) default '',
 ...
 KEY `page_uid` (`page_uid`),
 KEY `tx_multishop_bank_name` (`tx_multishop_bank_name`),
 KEY `tx_multishop_iban` (`tx_multishop_iban`),
 KEY `tx_multishop_bic` (`tx_multishop_bic`),
 KEY `tx_multishop_vat_id` (`tx_multishop_vat_id`),
...
CREATE TABLE `tx_multishop_dashboard` (
 `id` int(11) NOT NULL auto_increment,
 `header_title` varchar(127) default '',
 `dashboard_layout` varchar(30) default 'layout2cols',
 `crdate` int(11) default '0',
 `cruser_id` int(11) default '0',
 `status` tinyint(1) default '0',
 `deleted` tinyint(1) default '0',
 PRIMARY KEY (`id`),
 KEY `header_title` (`header_title`),
 KEY `crdate` (`crdate`),
 KEY `cruser_id` (`cruser_id`),
 KEY `status` (`status`),
 KEY `deleted` (`deleted`)
...
CREATE TABLE `tx_multishop_dashboard_portlets` (
 `id` int(11) NOT NULL auto_increment,
 `dashboard_id` int(11) default '0',
 `crdate` int(11) default '0',
 `header_title` varchar(75) default '',
 `widget_key` varchar(127) default '',
 ...
 KEY `status` (`status`),
 KEY `deleted` (`deleted`),
 UNIQUE KEY `widgets` (`dashboard_id`, `widget_key`),
);
