<?php
	...
	$mcFileManagerConfig['filesystem.path'] = $_SERVER['DOCUMENT_ROOT']."/fileadmin/user_upload/"; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT']."/fileadmin/user_upload/"; // absolute or relative from this script path.
