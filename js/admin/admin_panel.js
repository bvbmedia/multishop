...
*/
        ...
        jQuery.each(json, function (tablevel1_key, tablevel1) {
            tab_counter++;
            var tablevel1_label=true;
            if (typeof tablevel1.label=='undefined') {
                tablevel1_label=false;
            } else {
                if (tablevel1.label == null) {
                    tablevel1_label=false;
                }
            }
            if (!tablevel1_label && tablevel1.description) {
                admin_content += tablevel1.description;
            } else {
                var active_class='';
                if (tablevel1.active!=undefined && tablevel1.active==1) {
                ...
                if (tablevel1.subs == null) {
                    ...
                    switch(menuType) {
                        case 'collapse':
                            newheader_tree += '<a href="#subs' + tablevel1_key + '" id="subsA' + tablevel1_key + '" class="a_dropdown collapsed admin_panel_menu" role="button" data-toggle="collapse" data-parent="#tx_multishop_admin_header" data-link="' + (tablevel1.link != undefined ? tablevel1.link : '#') + '" aria-expanded="false" aria-controls="subs' + tablevel1_key + '">';
                            break;
                        case 'dropdown':
                            newheader_tree += '<a href="' + (tablevel1.link != undefined ? tablevel1.link : '#') + '" id="subsA' + tablevel1_key + '" class="a_dropdown admin_panel_menu" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">';
                            break;
                    }
                    if (tablevel1.class) {
                        newheader_tree += '<i class="' + tablevel1.class + '"></i>';
                    }
                    newheader_tree += tablevel1.label + '</a>';
                    switch(menuType) {
                        case 'collapse':
                            newheader_tree += '<ul id="subs' + tablevel1_key + '" class="panel-collapse collapse" role="tabpanel" aria-labelledby="subsA' + tablevel1_key + '">';
                            break;
                        case 'dropdown':
                    ...
                    jQuery.each(tablevel1.subs, function (tablevel2_key, tablevel2) {
                        ...
                        if (tablevel2.subs == null) {
                            if (tablevel2.link) {
                                newheader_tree += '<li class="' + tablevel2_params + ' ' + active_class + '"><a href="' + tablevel2.link + '"' + (tablevel2.link_params != undefined ? tablevel2.link_params : '') + ' class="admin_panel_menu">';
                                if (tablevel2.class) {
                                    newheader_tree += '<i class="' + tablevel2.class + '"></i>';
                                }
                                newheader_tree += tablevel2.label + '<span class="ms_admin_menu_item_description"></span></a></li>';
                            } else {
                                newheader_tree += '<li class="' + tablevel2_params + ' ' + active_class + '"><span>';
                                if (tablevel2.class) {
                                    newheader_tree += '<i class="' + tablevel2.class + '"></i>';
                                }
                                newheader_tree += tablevel2.label + '<span class="ms_admin_menu_item_description"></span></span></li>';
                            }
                            ...
                            jQuery.each(tablevel2.subs, function (tablevel3_key, tablevel3) {
                                ...
                                if (tablevel3.subs == null) {
                                    newheader_tree += '<li class="' + tablevel3_key + ' ' + active_class + '">';
                                    if (tablevel3.link) {
                                        /*
                                         if (tablevel3.description != null) {
                                         newheader_tree += '<a href="' + tablevel3.link + '"' + (tablevel3.link_params != undefined ? tablevel3.link_params : '') + '>' + tablevel3.label + '<span class="ms_admin_menu_item_description">' + tablevel3.description + '</span></a>';
                                         } else {
                                         newheader_tree += '<a href="' + tablevel3.link + '"' + (tablevel3.link_params != undefined ? tablevel3.link_params : '') + '>' + tablevel3.label + '<span class="ms_admin_menu_item_description"></span></a>';
                                         }
                                         */
                                        newheader_tree += '<a href="' + tablevel3.link + '"' + (tablevel3.link_params != undefined ? tablevel3.link_params : '') + ' class="admin_panel_menu">';
                                        if (tablevel3.class) {
                                            newheader_tree += '<i class="' + tablevel3.class + '"></i>';
                                        }
                                        newheader_tree += tablevel3.label + '<span class="ms_admin_menu_item_description"></span></a>';
                                    } else {
                                        newheader_tree += '<span>';
                                        if (tablevel3.class) {
                                            newheader_tree += '<i class="' + tablevel3.class + '"></i>';
                                        }
                                        newheader_tree += tablevel3.label + '<span class="ms_admin_menu_item_description"></span></span>';
                                    }
                                    newheader_tree += '</li>';

                                } else {
                                    newheader_tree += '<li class="' + (tablevel3_key != '' ? tablevel3_key + ' ' : '') + 'ms_admin_has_subs' + ' ' + active_class + '">';

                                    if (tablevel3.link) {
                                        newheader_tree += '<a href="' + tablevel3.link + '"' + (tablevel3.link_params != undefined ? tablevel3.link_params : '') + ' class="a_dropdown admin_panel_menu">';
                                        if (tablevel3.class) {
                                            newheader_tree += '<i class="' + tablevel3.class + '"></i>';
                                        }
                                        newheader_tree += tablevel3.label + '<span class="ms_admin_menu_item_description"></span></a>';
                                    ...
                                    jQuery.each(tablevel3.subs, function (tablevel4_key, tablevel4) {
                                        ...
                                        if (tablevel4.subs == null) {
                                            newheader_tree += '<li class="' + tablevel4_key + ' ' + active_class + '">';

                                            if (tablevel4.link) {
                                                newheader_tree += '<a href="' + tablevel4.link + '"' + (tablevel4.link_params != undefined ? tablevel4.link_params : '') + ' class="admin_panel_menu">';
                                                if (tablevel4.class) {
                                                    newheader_tree += '<i class="' + tablevel4.class + '"></i>';
                                                }
                                                newheader_tree += tablevel4.label + '<span class="ms_admin_menu_item_description"></span></a>';
                                            } else {
                                                newheader_tree += '<span>';
                                                if (tablevel4.class) {
                                                    newheader_tree += '<i class="' + tablevel4.class + '"></i>';
                                                }
                                                newheader_tree += tablevel4.label + '<span class="ms_admin_menu_item_description"></span></span>';
                                            }

                                            newheader_tree += '</li>';
                                        } else {

                                            newheader_tree += '<li class="ms_admin_has_subs ' + tablevel4_key + ' ' + active_class + '">';

                                            if (tablevel4.link) {
                                                newheader_tree += '<a href="' + tablevel4.link + '"' + (tablevel4.link_params != undefined ? tablevel4.link_params : '') + ' class="a_dropdown admin_panel_menu">';
                                                if (tablevel4.class) {
                                                    newheader_tree += '<i class="' + tablevel4.class + '"></i>';
                                                }
                                                newheader_tree += tablevel4.label + '<span class="ms_admin_menu_item_description"></span></a>';
                                            ...
                                            jQuery.each(tablevel4.subs, function (tablevel5_key, tablevel5) {
                                                ...
                                                newheader_tree += '<li class="' + tablevel5_key + ' ' + active_class + '">';

                                                if (tablevel5.link) {
                                                    newheader_tree += '<a href="' + tablevel5.link + '"' + (tablevel5.link_params != undefined ? tablevel5.link_params : '') + ' class="a_dropdown admin_panel_menu">';
                                                    if (tablevel5.class) {
                                                        newheader_tree += '<i class="' + tablevel5.class + '"></i>';
                                                    }
                                                    newheader_tree += tablevel5.label + '<span class="ms_admin_menu_item_description"></span></a>';
                                                    ...
                                                    newheader_tree += tablevel5.label + '<span class="ms_admin_menu_item_description"></span></span>';
                                                }
