...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPItoST43($_EXTKEY, 'pi1/class.tx_multishop_pi1.php', '_pi1', 'list_type', 0);
if (TYPO3_MODE=='BE') {
	// Page module hook
...
// Multishop cli
$TYPO3_CONF_VARS['SC_OPTIONS']['GLOBAL']['cliKeys']['multishop']=array(
