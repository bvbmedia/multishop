...
//		$row2=$GLOBALS['TYPO3_DB']->sql_fetch_row($qry2);
	...
	public function getProductInfo($product_id, $category_id, $page_uid='') {
		...
		$qry=$GLOBALS['TYPO3_DB']->SELECTquery('*', // SELECT ...
			...
			'pd.products_id=\''.$product_id.'\' and p2c.categories_id=\''.$category_id.'\' and pd.page_uid=\''.$page_uid.'\' and pd.page_uid=p2c.page_uid and pd.products_id=p2c.products_id', // WHERE...
			'', // GROUP BY...
			'', // ORDER BY...
			'' // LIMIT ...
		);
