						...
						while ($products_options_values=$GLOBALS['TYPO3_DB']->sql_fetch_assoc($products_options)) {
							...
							if ($this->ms['MODULES']['ENABLE_ATTRIBUTE_VALUE_IMAGES']) {
								...
								if (!empty($products_options_values['attribute_image'])) {
                                    ...
                                    $tooltip_attribute_image=htmlspecialchars('<div class="valuesdesc_info"><img src="'.mslib_befe::getImagePath($products_options_values['attribute_image'], 'attribute_values', 'original').'" />');
                                    $attribute_value_image='<a href="#" data-placement="left" class="values_desc_tooltip" title="'.$tooltip_attribute_image.'"><img src="'.mslib_befe::getImagePath($products_options_values['attribute_image'], 'attribute_values', 'original').'" alt="'.$image_alt.'" class="attribute_value_images" width="20px" height="20px" /></a>';
								}
							}
