    ...
    public function renderHeaderButtons() {
        if (is_array($this->headerButtons)) {
            ...
            foreach ($this->headerButtons as $headingButton) {
                $content .= '<a href="' . $headingButton['href'] . '" class="' . $headingButton['btn_class'] . '"' . ($headingButton['attributes'] ? ' ' . $headingButton['attributes'] : '') . ($headingButton['target'] ? ' target="' . $headingButton['target'] . '"' : '') . 'title="' . $headingButton['alt'] . '"><i class="' . $headingButton['fa_class'] . '"></i> ' . htmlspecialchars($headingButton['title']) . '</a> ';
            }
            $content .= '</div>';
            return $content;
        }
